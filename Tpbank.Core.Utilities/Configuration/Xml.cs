/*
 * Tpbank.Core.Utilities.Configuration Class Library
 * 
 * Written by Alvaro Mendez
 * Copyright (c) 2004. All Rights Reserved.
 * 
 * The Tpbank.Core.Utilities.Configuration namespace contains interfaces and classes that 
...
namespace Tpbank.Core.Utilities.Configuration
{
	/// <summary>
